 ...
 */
public class GetTokenByAuthorizationCodeTask extends AsyncTask<GoogleAccountCredentials, Void, Map<String, Object>> {
    ...
    protected Map<String, Object> doInBackground(GoogleAccountCredentials... params) {
        NetworkErrorDescriptor err = OAuthApis.getAllNewTokensForGoogleAccount(params[0]);
